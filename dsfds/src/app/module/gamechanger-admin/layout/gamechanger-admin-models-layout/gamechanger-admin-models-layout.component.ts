...
import {MovieService} from 'src/app/store/service/movie.service';import {ActorService} from 'src/app/store/service/actor.service';import {StudioService} from 'src/app/store/service/studio.service'; 
...
export class GamechangerAdminModelsLayoutComponent implements OnInit {
  ...
  constructor(
    ...
    private movieService : MovieService,private actorService : ActorService,private studioService : StudioService, 
  ) { 
