variable "bucket_name_production" {
  type    = string
  default = "angular-client-gamechanger-production"
}
variable "bucket_name_staging" {
  type    = string
  default = "angular-client-gamechanger-staging"
}
  ...
  "Statement": [
    {
      ...
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::angular-client-gamechanger-production/*"
    }
  ]
}
EOF
  ...
  "Statement": [
    {
      ...
      "Principal": "*",
      "Action": "s3:GetObject",
      "Resource": "arn:aws:s3:::angular-client-gamechanger-staging/*"
    }
  ]
}
EOF
...
resource "aws_cloudfront_distribution" "s3_distribution_production" {
  ...
  comment             = "Production angular-client-gamechanger CloudFront"
...
resource "aws_cloudfront_distribution" "s3_distribution_staging" {
  ...
  http_version        = "http2"
  is_ipv6_enabled     = true
  comment             = "Staging angular-client-gamechanger CloudFront"
  default_root_object = "index.html"
