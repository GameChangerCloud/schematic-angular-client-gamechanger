...
describe('Parse GraphQL schema into an object', () => {
  ...
  describe('Type RootQuery', () => {
    ...
    it('Schema should have the properties with the null type and array type', () => {
      expect(schema.RootQuery.fields).to.have.deep.include({
        name: 'getUser',
        type: 'User',
        noNull: false,
        isArray: false,
  ...
  describe('Type RootMutation', () => {
    ...
    it('Schema should have the properties with the null type and array type', () => {
      ...
      expect(schema.RootMutation.fields).to.have.deep.include({
        name: 'createUser',
        type: 'User',
        noNull: false,
        isArray: false,
  ...
  describe('Type UserInput', () => {
    ...
    it('Schema should have the properties with the null type and array type', () => {
      expect(schema.UserInput.fields).to.have.deep.include({
        name: 'email',
        type: 'String',
        noNull: true,
        isArray: false,
